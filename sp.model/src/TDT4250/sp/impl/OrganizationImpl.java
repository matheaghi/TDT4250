 ...
 * </p>
 * <ul>
 *   <li>{@link TDT4250.sp.impl.OrganizationImpl#getDepartments <em>Departments</em>}</li>
 *   <li>{@link TDT4250.sp.impl.OrganizationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrganizationImpl extends MinimalEObjectImpl.Container implements Organization {
	...
	protected EClass eStaticClass() {
		return SpPackage.Literals.ORGANIZATION;
	}
	...
	public EList<Department> getDepartments() {
		if (departments == null) {
			departments = new EObjectContainmentEList<Department>(Department.class, this, SpPackage.ORGANIZATION__DEPARTMENTS);
		}
		return departments;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpPackage.ORGANIZATION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SpPackage.ORGANIZATION__DEPARTMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SpPackage.ORGANIZATION__NAME:
				return getName();
		}

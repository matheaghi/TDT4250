...
public class SpSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SpPackage.SEMESTER_INSTANCE: {
				SemesterInstance semesterInstance = (SemesterInstance)theEObject;
				T result = caseSemesterInstance(semesterInstance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SpPackage.ELECTABLES_COURSE_SLOT: {
				ElectablesCourseSlot electablesCourseSlot = (ElectablesCourseSlot)theEObject;
				T result = caseElectablesCourseSlot(electablesCourseSlot);
				if (result == null) result = caseCourseSlot(electablesCourseSlot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SpPackage.OBLIGATORY_COURSE_SLOT: {
				ObligatoryCourseSlot obligatoryCourseSlot = (ObligatoryCourseSlot)theEObject;
				T result = caseObligatoryCourseSlot(obligatoryCourseSlot);
				if (result == null) result = caseCourseSlot(obligatoryCourseSlot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Semester Instance</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Semester Instance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSemesterInstance(SemesterInstance object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Electables Course Slot</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Electables Course Slot</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElectablesCourseSlot(ElectablesCourseSlot object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Obligatory Course Slot</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Obligatory Course Slot</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObligatoryCourseSlot(ObligatoryCourseSlot object) {
		return null;
	}
